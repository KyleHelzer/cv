---
title: "Kyle T Helzer's CV"
author: Kyle T Helzer
date: "`r Sys.Date()`"
params:
  pdf_mode:
    value: true
...
CV <- create_CV_object(
  data_location = "https://docs.google.com/spreadsheets/d/1V1gK3mffo1E4IkLR8fC6JjK9il7NukCSTr6YyUfP23o/edit?usp=sharing",  
...
Presentations  {data-icon=microphone}
--------------------------------------------------------------------------------
...
Conferences Attended  {data-icon=users}
--------------------------------------------------------------------------------
